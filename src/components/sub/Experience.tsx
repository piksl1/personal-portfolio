    ...
    <div className="relative py-20 px-96">
      ...
      >
        {experienceData.map((data, i) => (
          <div
            key={`id-${i}`}
            className={`w-[600px] xl:w-[480] sm:w-full px-12 sm:px-0 relative ${
              i % 2 === 0
          ...
          >
            ...
            >
              ...
              <span
                className={`absolute top-20 left-full text-red-300 -translate-y-1/2 ${
            ...
            <div
              className={`w-14 absolute top-20 left-full border border-gray-300 rounded-full aspect-square grid place-items-center text-red-400 font-light -translate-y-1/2 z-10 bg-white ${
                i % 2 === 0
