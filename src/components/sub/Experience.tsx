...
const Experience = () => {
  return (
    <div className="relative py-20 px-96">
      ...
      <Image className="absolute -top-4 right-96 opacity-70 lg:hidden" src={"/education.jpg"} alt={"about me"} width={400} height={400} />
      <div className="w-full h-full flex flex-col items-center justify-center gap-y-10 lg:gap-y-20 py-10">
        <div className="w-[600px] xl:w-[480] sm:w-full px-12 sm:px-0 relative left-[300px]">
          ...
          <div className="w-14 absolute top-20 left-full border border-gray-300 rounded-full aspect-square grid place-items-center text-red* font-light">2022</div>
        </div>
